...
import com.drhdn.ghvis.infrastructure.adapter.outbound.events.EventPublisherAdapter;
...
public class StreamController {
    ...
    public StreamController(EventPublisherAdapter eventPublisherAdapter) {
    ...
    public Flux<ServerSentEvent<Event>> streamEvents(@RequestParam("repo") String repoParam) {
        ...
        System.out.println("🔗 EventPublisherAdapter disponible: " + (eventPublisherAdapter != null));
        ...
        Flux<ServerSentEvent<Event>> eventFlux = eventPublisherAdapter.flux()
